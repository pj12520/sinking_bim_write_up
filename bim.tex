...
D = \frac{3}{4 \Bo} \left[2 \sin \theta_{\text{c}} \sin(\chi - \theta_{\text{c}}) + \Bo \left( -\frac{z'_{\text{c}} \sin^{2} \theta_{\text{c}}}{\Bo^{1/2}} + \frac{2}{3} + \cos \theta_{\text{c}} - \frac{\cos \theta_{\text{c}}}{3}\right)\right]. 
\end{equation}
...
D = \frac{3 \Delta^{1/2}}{4 \Bo} \left[2 \sin^{2} \theta_{\text{c}} + \Bo \Delta \left( -\frac{z'_{\text{c}} \sin^{2} \theta_{\text{c}}}{\Bo^{1/2} \Delta^{1/2}} + \frac{2}{3} + \cos \theta_{\text{c}} - \frac{\cos^{3} \theta_{\text{c}}}{3}\right)\right],
\end{equation}
